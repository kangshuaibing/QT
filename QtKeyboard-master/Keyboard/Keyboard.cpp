...
QList<Modes> modeListBar1;
QList<Modes> modeListBar2;
QList<Modes> modeListBar3;
QList<Modes> modeListBar4;
...
//const QList<Modes> modeListBar2 = QList<Modes>{
...
//const QList<Modes> modeListBar3 = QList<Modes>{
...
//const QList<Modes> modeListBar4 = QList<Modes>{
...
Keyboard::Keyboard(QWidget *parent) :
    ...
    m_isChinese(false)
{
    QList<KeyButton::Mode> mode0 = {{Qt::Key_Q, "q"}, {Qt::Key_Q, "Q"}, {Qt::Key_1, "1"}};
    QList<KeyButton::Mode> mode1 = {{Qt::Key_W, "w"}, {Qt::Key_W, "W"}, {Qt::Key_2, "2"}};
    QList<KeyButton::Mode> mode2 = {{Qt::Key_E, "e"}, {Qt::Key_E, "E"}, {Qt::Key_3, "3"}};
    QList<KeyButton::Mode> mode3 = {{Qt::Key_R, "r"}, {Qt::Key_R, "R"}, {Qt::Key_4, "4"}};
    QList<KeyButton::Mode> mode4 = {{Qt::Key_T, "t"}, {Qt::Key_T, "T"}, {Qt::Key_5, "5"}};
    QList<KeyButton::Mode> mode5 = {{Qt::Key_Y, "y"}, {Qt::Key_Y, "Y"}, {Qt::Key_6, "6"}};
    QList<KeyButton::Mode> mode6 = {{Qt::Key_U, "u"}, {Qt::Key_U, "U"}, {Qt::Key_7, "7"}};
    QList<KeyButton::Mode> mode7 = {{Qt::Key_I, "i"}, {Qt::Key_I, "I"}, {Qt::Key_8, "8"}};
    QList<KeyButton::Mode> mode8 =  {{Qt::Key_O, "o"}, {Qt::Key_O, "O"}, {Qt::Key_9, "9"}};
    QList<KeyButton::Mode> mode9 = {{Qt::Key_P, "p"}, {Qt::Key_P, "P"}, {Qt::Key_0, "0"}};
    modeListBar1.append(mode0);
    modeListBar1.append(mode1);
    modeListBar1.append(mode2);
    modeListBar1.append(mode3);
    modeListBar1.append(mode4);
    modeListBar1.append(mode5);
    modeListBar1.append(mode6);
    modeListBar1.append(mode7);
    modeListBar1.append(mode8);
    modeListBar1.append(mode9);

    mode0 = {{Qt::Key_A, "a"}, {Qt::Key_A, "A"}, {Qt::Key_unknown, "~"}};
    mode1 = {{Qt::Key_S, "s"}, {Qt::Key_S, "S"}, {Qt::Key_unknown, "!"}};
    mode2 =  {{Qt::Key_D, "d"}, {Qt::Key_D, "D"}, {Qt::Key_At,      "@"}};
    mode3 = {{Qt::Key_F, "f"}, {Qt::Key_F, "F"}, {Qt::Key_NumberSign, "#"}};
    mode4 = {{Qt::Key_G, "g"}, {Qt::Key_G, "G"}, {Qt::Key_Percent, "%"}};
    mode5 =  {{Qt::Key_H, "h"}, {Qt::Key_H, "H"}, {Qt::Key_unknown, "'"}};
    mode6 = {{Qt::Key_J, "j"}, {Qt::Key_J, "J"}, {Qt::Key_unknown, "&", "&&"}};
    mode7 = {{Qt::Key_K, "k"}, {Qt::Key_K, "K"}, {Qt::Key_unknown, "*"}};
    mode8 = {{Qt::Key_L, "l"}, {Qt::Key_L, "L"}, {Qt::Key_unknown, "?"}};
    modeListBar2.append(mode0);
    modeListBar2.append(mode1);
    modeListBar2.append(mode2);
    modeListBar2.append(mode3);
    modeListBar2.append(mode4);
    modeListBar2.append(mode5);
    modeListBar2.append(mode6);
    modeListBar2.append(mode7);
    modeListBar2.append(mode8);

    mode0 = {{Qt::Key_CapsLock, "", ""/*大小写切换*/}};
    mode1 =  {{Qt::Key_Z, "z"}, {Qt::Key_Z, "Z"}, {Qt::Key_ParenLeft, "("}};
    mode2 =  {{Qt::Key_X, "x"}, {Qt::Key_X, "X"}, {Qt::Key_ParenLeft, ")"}};
    mode3 =  {{Qt::Key_C, "c"}, {Qt::Key_C, "C"}, {Qt::Key_Minus,     "-"}};
    mode4 =  {{Qt::Key_V, "v"}, {Qt::Key_V, "V"}, {Qt::Key_unknown,   "_"}};
    mode5 =  {{Qt::Key_B, "b"}, {Qt::Key_B, "B"}, {Qt::Key_unknown,   ":"}};
    mode6 =  {{Qt::Key_N, "n"}, {Qt::Key_N, "N"}, {Qt::Key_Semicolon, ";"}};
    mode7 = {{Qt::Key_M, "m"}, {Qt::Key_M, "M"}, {Qt::Key_Slash,     "/"}};
    mode8 = {{Qt::Key_Backspace, "", ""/*退格*/}};
    modeListBar3.append(mode0);
    modeListBar3.append(mode1);
    modeListBar3.append(mode2);
    modeListBar3.append(mode3);
    modeListBar3.append(mode4);
    modeListBar3.append(mode5);
    modeListBar3.append(mode6);
    modeListBar3.append(mode7);
    modeListBar3.append(mode8);

    mode0 = {{Qt::Key_Mode_switch, "",  "?123"}};
    mode1 = {{Qt::Key_Context1,    "",  "En"},    {Qt::Key_Context1, "", "中"}};
    mode2 =  {{Qt::Key_Space,       " ", ""/*空格*/}};
    mode3 = {{Qt::Key_Enter,       "",  ""/*换行*/}};
    modeListBar4.append(mode0);
    modeListBar4.append(mode1);
    modeListBar4.append(mode2);
    modeListBar4.append(mode3);

//    std::list<std::list<std::string>> str = {
//        {"1","2","3"},
//        {"4","5","6"},
//        {"7","8","9"},
//    };
//    foreach(std::list<std::string> s ,str)
//    {
//        foreach(std::string s1 ,s)
//        {
//            QString p = QString::fromStdString(s1);
//        qDebug()<<p<<endl;
//        }
//    }
...
QHBoxLayout *Keyboard::h1()
{
    ...
    {
        qDebug()<<modeListBar1.size();
        qDebug()<<modeListBar1.at(i).size();
